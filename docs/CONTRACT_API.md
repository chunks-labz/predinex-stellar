...
```rust
pub fn set_token_exchange_rate(env: Env, caller: Address, token: Address, rate_bps: i128,) -> Result<(), ContractError>
```
...
```rust
pub fn create_multi_asset_pool(env: Env, creator: Address, title: String, description: String, outcomes: Vec<String>, duration: u64, allowed_tokens: Vec<Address>, metadata_uri: Option<String>, deposit_deadline: Option<u64>,) -> Result<u32, ContractError>
```
...
```rust
pub fn set_pool_token_bet_limits(env: Env, caller: Address, pool_id: u32, token: Address, min_bet: i128, max_bet: i128,) -> Result<(), ContractError>
```
...
```rust
pub fn place_multi_asset_bet(env: Env, user: Address, pool_id: u32, outcome: u32, amount: i128, bet_token: Address, referrer: Option<Address>,) -> Result<(), ContractError>
```
...
```rust
pub fn claim_multi_asset_winnings(env: Env, user: Address, pool_id: u32,) -> Result<MultiAssetClaimResult, ContractError>
```
